  ...
  AppTheme.greenDark: ThemeData(
      ...
      textTheme: TextTheme(
        ...
        displaySmall: TextStyle(
            color: Colors.white, fontSize: 12.sp, fontFamily: 'Rubik'),
        headlineLarge: TextStyle(
            color: Colors.white, fontSize: 24.sp, fontFamily: 'Rubik'),
        titleMedium: TextStyle(
            color: Colors.white, fontSize: 14.sp, fontFamily: 'Rubik'),
